...
export const industries: IndustryItem[] = [
  ...
  },
  {
    ...
    description:
      'Modernize banking operations, client experiences, and digital finance workflows with AI-enabled and FinTech-ready infrastructure.',
    icon: Landmark,
    outcomes: ['Operations intelligence', 'Risk visibility', 'Digital channel modernization'],
    challenges: [
      'Fragmented operations data across branches and products',
      'Slow exception handling and reporting cycles',
      'Pressure to modernize digital channels with strong controls',
    ],
    capabilities: [
